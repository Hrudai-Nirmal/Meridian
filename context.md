...
- Added visible Automation Map connection handles: each node has a left input and right output connector; in Edit mode, editors can drag output-to-input wires to create autosaved visual links while self-links and duplicate source-target links are blocked.
...
- Browser-test Automation Map connection handles: view mode should not create links, Edit mode should allow output-to-input drag linking, self-links and duplicate same-direction links should be blocked, and autosaved links should survive refresh.
